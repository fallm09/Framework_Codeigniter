...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="<?php echo base_url('Client/index');?> " target="_blank">Inserer Client</a></li>
			<li class="menu-item hidden"><a
					href="<?php echo base_url('Client/index');?>" target="_blank">Inserer Compte</a>
			</li>
		</ul>
	</div>
